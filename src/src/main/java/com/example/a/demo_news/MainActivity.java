...
public class MainActivity extends AppCompatActivity {
    ...
    List<MyData.TopStoriesBean> topStoriesBeans = new ArrayList<>();
    List<MyData.StoriesBean> storiesBeans = new ArrayList<>();
    ...
    public void getDataByRetrofit() {
        ...
        call.enqueue(new Callback<MyData>() {
            ...
            public void onResponse(@NonNull Call<MyData> call, @NonNull Response<MyData> response) {
                ...
                topStoriesBeans = data.getTop_stories();
                recyclerAdapter.addItem(data.getStories());
                storiesBeans.addAll(data.getStories());
//                recyclerAdapter.setDate(data.getDate());
                date = data.getDate();
                List<String> images = new ArrayList<>();
                for(MyData.TopStoriesBean b : topStoriesBeans){
                    images.add(b.getImage());
                }
                recyclerAdapter.addViewPager(images);
